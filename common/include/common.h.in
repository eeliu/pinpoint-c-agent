...
/**
 * @brief treat current span as SpanChunk with async_node (pinpoint-c-agent, is only works on
 * [PSpanChunk](https://github.com/pinpoint-apm/pinpoint-grpc-idl/blob/d5ea1a65548eb624c7ed1c441226742105c3a6bc/proto/v1/Span.proto#L106).
 * async_node_id is generated by common like `generate_unique_id`
 * @param id
 * @param async_node_id
 * @param node_sequence
 */
